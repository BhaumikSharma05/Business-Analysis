...
2. **Data Analysis & Modeling**  
   - Applied **Pivot Tables**, **Conditional Formatting**, and advanced formulas (`SUMIFS`, `INDEX-MATCH`, `IFERROR`) to summarize metrics.  
   - Introduced calculated fields for profit ratios and category-wise growth rates.  
   - Enabled **slicers** and **timelines** for interactive filtering.  

3. **Dashboard Development**  
   - Designed an **executive-style dashboard** using bar, line, and donut charts.  
